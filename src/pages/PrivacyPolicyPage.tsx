...
const SECTIONS = [
  ...
  { t: "5. Trusted Partners We Work With", b: "We run on a small number of established providers who only get the data they need to do their job: Supabase (our database and sign-in), Stripe (payments and creator payouts), Vercel (hosting), Cloudflare (storing the photos and videos you upload), OneSignal (push notifications), LocationIQ (location search), and Sentry (error monitoring) - plus optional sign-in via Google, Apple, TikTok, or Instagram. We don't sell your data to anyone." },
