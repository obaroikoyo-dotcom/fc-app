const SECTIONS = [
  ...
  { t: "7. Data Retention", b: "Retained while your account is active. Deleted within 30 days of account deletion, except payment records kept 6 years under UK law. Photos and videos shared during a deal (deliverables, pitch videos, chat media) are automatically deleted once that deal closes - typically within 24 hours of payout, immediately if a pitch is declined, or after 7 days of inactivity - though the conversation and its text always stay. Deleting your account or being banned removes all of your media immediately." },
