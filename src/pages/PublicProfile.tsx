              ...
              {displayPlatforms.map(p => {
                ...
                <div key={p} style={{ background: "#111", border: "1px solid #1a1a1a", borderRadius: "16px", overflow: "hidden" }}>
                  <div style={{ padding: "14px 16px" }}>
                    ...
                    {(verified?.username || creator.social_links?.[p]) && <p style={{ color: "#999", fontSize: "12px", marginTop: "3px" }}>@{verified?.username || creator.social_links?.[p]}</p>}
                    {(followers != null || creator.engagement_rates?.[p]) && (
                      <div style={{ display: "flex", gap: "1.5rem", marginTop: "12px" }}>
                        ...
                        {creator.engagement_rates?.[p] && (
                          <div>
                            <p style={{ color: "#fff", fontSize: "16px", fontWeight: 700, fontVariantNumeric: "tabular-nums", lineHeight: 1 }}>{creator.engagement_rates[p]}%</p>
