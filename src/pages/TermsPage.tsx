const SECTIONS = [
  ...
  { t: "4. Payments & Escrow", b: "All payments are processed via Stripe. A brand's payment is held in escrow and released to the creator once the deliverable is confirmed live, manually released by the brand, or (if the brand opts out of requiring a confirmed post) immediately on payment. Creator payouts are transferred directly to the creator's own connected Stripe account - FlipCollab never holds a creator's bank details. Disputes must be raised within 7 days to hello@flipcollab.com; FlipCollab may hold, release, or refund escrowed funds at its reasonable discretion while a dispute is under review." },
