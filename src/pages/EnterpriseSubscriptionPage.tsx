...
export default function EnterpriseSubscriptionPage({ navigate }: { navigate: (page: Page) => void }) {
  ...
  Upgrade to Enterprise
      ...
      {showModal && (
        <div onClick={() => !paymentLoading && setShowModal(false)} style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.85)", zIndex: 9999, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "1.25rem", paddingBottom: "2rem" }}>
