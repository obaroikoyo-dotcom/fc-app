...
const togglePlatform = (p: string) =>
  ...
  const saveProfile = async () => {
    ...
    setSaving(true);
    const profileData = {
      id: userId, name, bio, niche, location, age, gender, available,
      platforms: selectedPlatforms, social_links: socialLinks,
      follower_counts: followerCounts, engagement_rates: engagementRates,
      content_types: contentTypes, languages, audience_age_range: audienceAgeRange,
      audience_location: audienceLocation, rates, collabs,
    };
