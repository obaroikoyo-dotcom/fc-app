...
function CreatorNav({ page, navigate, isInverted, unreadCount = 0 }: NavProps) {
  ...
  return (
    <div style={{ borderTop: `1px solid ${borderColor}`, display: "flex", padding: "0.75rem 0 calc(0.75rem + env(safe-area-inset-bottom, 0px)) 0", background: bgColor, position: "fixed", bottom: 0, width: "100%", zIndex: 100, transition: "background 0.2s ease, border-color 0.2s ease" }}>
...
function BrandNav({ page, navigate, tab, setTab, setViewingProfileId, isInverted, unreadCount = 0 }: BrandNavProps) {
  ...
  return (
    <div style={{ borderTop: `1px solid ${borderColor}`, display: "flex", padding: "0.75rem 0 calc(0.75rem + env(safe-area-inset-bottom, 0px)) 0", background: bgColor, position: "fixed", bottom: 0, width: "100%", zIndex: 100, touchAction: "manipulation", transition: "background 0.2s ease, border-color 0.2s ease" }}>
